...
public class RemoveProductCommand implements Command<Cart> {
    ...
    public RemoveProductCommand(String productId, UserDetails userDetails, IUserService userService,
    ...
    @Override
    public Cart execute() {
        this.result = this.cartService.removeProduct(user, product);
        return result;
    }

    @Override
    public Cart undo() throws BadRequestException {
