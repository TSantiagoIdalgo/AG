...
public class DecreaseProductCommand implements Command<Cart> {
    ...
    public DecreaseProductCommand(String productId, UserDetails userDetails, IUserService userService,
